...
cfg.n_data = 400000  # number of images to generate
cfg.train_vs_val = 'train'
cfg.destination_dir = os.path.join('out_data/{:s}_{:s}_{:s}_seed{:d}'.format(cfg.name,
                                                                     cfg.train_vs_val,
                                                                     cfg.bnn_prior_class,
                                                                     cfg.seed))
...
cfg.psf = dict(
    ...
    which_psf_maps=None,
    # None if rotate among all available PSF maps, else seed number of the map to generate all images with that map
)
